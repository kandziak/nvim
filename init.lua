...
vim.api.nvim_set_keymap('n', '<C-t>', '<cmd>10split | terminal<CR>', { noremap = true, silent = true })
  ...
  { -- LSP Configuration & Plugins
    ...
    config = function()
      ...
      local servers = {
        ...
        tsserver = {
          on_attach = function()
            local function add_missing_imports_and_save()
            ...
            vim.keymap.set('n', '<Leader>I', add_missing_imports_and_save, { desc = 'Auto-import and save TS-only' })
          end,
        },
        --
